use crate::aliases::{SequenceNum, StageAndSequence, thread_index_to_thread_id, ThreadAndSequence, ThreadIndex};
use crate::err::{FatalError, KCasError, StageOutOfBoundsError};
use crate::kcas::{combine_stage_and_sequence, extract_sequence_from_stage_and_sequence, extract_stage_from_stage_and_sequence, HelpError, reset_for_next_operation, SharedState};
...
pub(super) fn verify_stage_and_sequence_have_not_changed<const NUM_THREADS: usize, const NUM_WORDS: usize>(
...
pub(super) fn help_change_stage_and_transition<const NUM_THREADS: usize, const NUM_WORDS: usize, F>(
    shared_state: &SharedState<NUM_THREADS, NUM_WORDS>,
    thread_index: ThreadIndex,
    sequence: SequenceNum,
    thread_and_sequence: ThreadAndSequence,
...
pub(super) fn handle_concurrent_stage_and_sequence_verification_error_and_transition<const NUM_THREADS: usize, const NUM_WORDS: usize>(
    shared_state: &SharedState<NUM_THREADS, NUM_WORDS>,
    thread_index: ThreadIndex,
    sequence: SequenceNum,
    thread_and_sequence: ThreadAndSequence,
...
pub(super) fn help_handle_concurrent_stage_and_sequence_verification_error_and_transition<const NUM_THREADS: usize, const NUM_WORDS: usize>(
    shared_state: &SharedState<NUM_THREADS, NUM_WORDS>,
    thread_index: ThreadIndex,
    sequence: SequenceNum,
    thread_and_sequence: ThreadAndSequence,
...
pub(super) fn handle_concurrent_stage_change_and_transition<const NUM_THREADS: usize, const NUM_WORDS: usize>(
    shared_state: &SharedState<NUM_THREADS, NUM_WORDS>,
    thread_index: ThreadIndex,
    sequence: SequenceNum,
    thread_and_sequence: ThreadAndSequence,
...
pub(super) fn help_handle_concurrent_stage_change_and_transition<const NUM_THREADS: usize, const NUM_WORDS: usize>(
    shared_state: &SharedState<NUM_THREADS, NUM_WORDS>,
    thread_index: ThreadIndex,
    sequence: SequenceNum,
    thread_and_sequence: ThreadAndSequence,
